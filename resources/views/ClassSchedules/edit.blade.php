        ...
        <div class="DivTemplate mt-3 pt-3">
            ...
            <div class="form-row mt-2">
                <div class="form-group col-sm-6">
                    ...
                    <input type="number" class="form-control" name="schoolYearFrom" value="{{$classSched->schoolYearFrom}}" required>
                </div>
                <div class="form-group col-sm-6">
                    <br>
                    <input type="number" class="form-control" name="schoolYearTo" value="{{$classSched->schoolYearTo}}" required>
                </div>
            </div>
