...
function Grade1SubjectsFunction(){
    $("#timeFields").append(
            '<tr>'+
                '<td><input type="time" name="inputArr[1][timeFrom]" id="" class="form-control" required></td>'+
                '<td><input type="time" name="inputArr[1][timeTo]" id="" class="form-control" required></td>'+
                '<td><input type="text" class="form-control" name="inputArr[1][subject]" value="Mother Tongue" readOnly/></td>'+
                '<td>'+
                    '<select name="inputArr[1][subjectTeacher]" class="form-control teachers" required>'+
                        '<option value="">Select</option>'+
