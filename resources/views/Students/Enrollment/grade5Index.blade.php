...
<div class="content content-margin pb-2" id="content">
    <div class="row header-bg" style="margin-top: 70px">
        <div class="col-sm-12">
            <p class="header-title d-inline"><a href="/gradeSelection" style="color: white"><i class="fas fa-arrow-left"></i></a> Grade 5 Enrollment</p>
        </div>
    </div>
    <div class="container">
                         ...
                         <tr>
                             ...
                             <td class="text-center">
                                    <form class="form-horizontal" method="POST" action="{{route('enrollShow')}}">
                                        ...
                                        <input type="hidden" value="Grade 5" name="gradeLevel">
                                        <button type="submit" class="search-button" >Records</button>
                                    </form>
                             </td>
                         </tr>
                     @elseif($student->grade5 == 'Not yet enrolled')
                         <tr>
                             <td class="align-middle">{{$student->username}}</td>
                             <td class="align-middle">{{$student->firstName}} {{$student->middleName}} {{$student->lastName}}</td>
