...
<div class="content content-margin pb-2" id="content">
    <div class="row header-bg" style="margin-top: 70px">
        <div class="col-sm-12">
            <p class="header-title d-inline"><a href="/gradeSelection" style="color: white"><i class="fas fa-arrow-left"></i></a> Grade 1 Enrollment</p>
        </div>
    </div>
    <div class="container">
                ...
                <tbody class="tbody-data">
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="search-button" onclick="window.location='{{ url('/showStudent') }}'">Records</button>
                        </td>
                    </tr>
                    <tr>
                        <td class="align-middle">A117A0909</td>
                        ...
                        <td class="text-center">
                            <button type="button" class="update-button" onclick="window.location='{{ route('enrollment.create') }}'">Enroll</button>
                        </td>
                    </tr>
                </tbody>
            </table>
