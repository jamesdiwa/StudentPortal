...
<body id="mainbody">
    <div id="master">
        ...
        <nav class="navbar navbar-expand-xl fixed-top navbar-light">
            <a href="/" class="logo-pointer" style="text-decoration: none;">
            <img src="{{ asset('images/logo.jpg') }}" class="mt-n1 mr-2" style="width: 30px; height: 30px">
            <p class="p-0 m-0 d-inline" style="color: #d11d27; font-weight: 600">Sacred Heart of Jesus Catholic School</p>
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            <i class="fas fa-ellipsis-v invisible" style="color: #d11d27"></i>
                        </a>
